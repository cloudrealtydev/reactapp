...
***REMOVED*** // Sets the exact value of the given location to the offset of the next
// Statement emitted.
...
***REMOVED*** // Shorthand for emitting assignment statements. This will come in handy
...
Ep.emitAssign = function (lhs, rhs) {
  ...
  return lhs;
***REMOVED*** // Shorthand for an assignment statement.


Ep.assign = function (lhs, rhs) {
  var t = util.getTypes();
  return t.expressionStatement(t.assignmentExpression("=", t.cloneDeep(lhs), rhs));
***REMOVED*** // Convenience function for generating expressions like context.next,
...
***REMOVED*** // Shorthand for setting context.rval and jumping to `context.stop()`.
...
***REMOVED*** // Emits code for an unconditional jump to the given location, even if the
...
***REMOVED*** // Conditional jump, with the condition negated.
...
***REMOVED*** // Returns a unique MemberExpression that can be used to store and
...
***REMOVED*** // Turns this.listing into a loop of the form
//
...
***REMOVED*** // All side effects must be realized in order.
...
***REMOVED*** // The context.prev property takes the value of context.next whenever we
