...
var getCustomMediaFromRoot = ((root, opts) => {
  ...
  const customMedias = {***REMOVED*** // for each custom selector atrule that is a child of the css root
...
function getCustomMediaFromSources(sources) {
  return sources.map(source => {
    ...
    const opts = source === Object(source) ? source : {
      from: String(source)
    ***REMOVED*** // skip objects with custom media
  ...
  function () {
    var _ref = _asyncToGenerator(function* (destination) {
      if (destination instanceof Function) {
        ...
        ***REMOVED*** // transformer for custom media into a JSON-compatible object
