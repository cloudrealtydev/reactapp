...
module.exports.pitch = function loader(request) {
  const options = _loaderUtils.default.getOptions(this) || {***REMOVED***
...
if (module.hot) {
  ...
  module.hot.dispose(function() {
    update();
        ...
        return `var options = ${JSON.stringify(options)***REMOVED***

options.insert = ${insert***REMOVED***
...
var options = ${JSON.stringify(options)***REMOVED***

options.insert = ${insert***REMOVED***
options.singleton = ${isSingleton***REMOVED***
