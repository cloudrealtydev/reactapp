...
class SourceCode extends TokenStore {
    ...
    constructor(textOrConfig, astIfNoConfig) {
         ...
         * @type {Object}
         */
        this.parserServices = parserServices || {***REMOVED***
    ...
    getLocFromIndex(index) {
        ...
        if (index === this.text.length) {
            return { line: this.lines.length, column: this.lines[this.lines.length - 1].length ***REMOVED***
        }
        ...
        return { line: lineNumber, column: index - this.lineStartIndices[lineNumber - 1] ***REMOVED***
    }
