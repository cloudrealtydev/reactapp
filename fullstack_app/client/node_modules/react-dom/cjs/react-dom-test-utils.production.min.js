...
return ja(a)}***REMOVED***function sa(a){return function(b,c){if(k.isValidElement(b))throw p(Error(228));if(W.isCompositeComponent(b))throw p(Error(229));var e=R[a],d=new T;d.target=b;d.type=a.toLowerCase();var f=la(b),h=new x(e,f,d,b);h.persist();g(h,c);e.phasedRegistrationNames?ma(h):na(h);m.unstable_batchedUpdates(function(){oa(b);qa(h)});pa()}}W.Simulate={***REMOVED***var X=void 0;for(X in R)W.Simulate[X]=sa(X);
