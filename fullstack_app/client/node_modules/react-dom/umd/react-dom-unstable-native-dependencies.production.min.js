...
target:null,currentTarget:function(){return null},eventPhase:null,bubbles:null,cancelable:null,timeStamp:function(a){return a.timeStamp||Date.now()},defaultPrevented:null,isTrusted:null***REMOVED***z.extend=function(a){function b(){return c.apply(this,arguments)}var c=this,f=function(){***REMOVED***f.prototype=c.prototype;f=new f;K(f,b.prototype);b.prototype=f;b.prototype.constructor=b;b.Interface=K({},c.Interface,a);b.extend=c.extend;S(b);return b***REMOVED***S(z);var w=z.extend({touchHistory:function(a){return null}});p=["touchstart",
...
a}}***REMOVED***n=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events;p=n[3];(function(a,b,c){Q=a;V=b;N=c})(n[2],n[0],n[1]);return{ResponderEventPlugin:I,ResponderTouchHistoryStore:u,injectEventPluginsByName:p}});
