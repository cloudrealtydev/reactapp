...
!1)});["capture","download"].forEach(function(a){p[a]=new r(a,4,!1,a,null,!1)});["cols","rows","size","span"].forEach(function(a){p[a]=new r(a,6,!1,a,null,!1)});["rowSpan","start"].forEach(function(a){p[a]=new r(a,5,!1,a.toLowerCase(),null,!1)});var Q=/[\-:]([a-z])/g,R=function(a){return a[1].toUpperCase()***REMOVED***"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(a){var b=
...
e.children,"string"===typeof g||"number"===typeof g){g=A(g);break a}g=null}null!=g?(e=[],Ia[b]&&"\n"===g.charAt(0)&&(w+="\n"),w+=g):e=z(e.children);a=a.type;c=null==c||"http://www.w3.org/1999/xhtml"===c?ma(a):"http://www.w3.org/2000/svg"===c&&"foreignObject"===a?"http://www.w3.org/1999/xhtml":c;this.stack.push({domNamespace:c,type:b,children:e,childIndex:0,context:d,footer:h});this.previousWasTextNode=!1;return w***REMOVED***return a}();k={renderToString:function(a){a=new ra(a,!1);try{return a.read(Infinity)}finally{a.destroy()}},
renderToStaticMarkup:function(a){a=new ra(a,!0);try{return a.read(Infinity)}finally{a.destroy()}},renderToNodeStream:function(){throw q(Error(207));},renderToStaticNodeStream:function(){throw q(Error(208));},version:"16.9.0"***REMOVED***k=(B={default:k},k)||B;return k.default||k});
