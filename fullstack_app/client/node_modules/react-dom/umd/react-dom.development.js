 ...
 */
var eventNameDispatchConfigs = {***REMOVED***

/**
 * Mapping from registration name to plugin module
 */
var registrationNameModules = {***REMOVED***
 ...
 * @type {Object}
 */
var possibleRegistrationNames = {***REMOVED***
...
var warningWithoutStack = function () {***REMOVED***
...
var eventTypes$4 = {***REMOVED***
var topLevelEventsToDispatchConfig = {***REMOVED***
...
function getSelection$1(input) {
  ...
  return selection || { start: 0, end: 0 ***REMOVED***
}
...
function getRootHostContext(rootContainerInstance) {
  ...
  }
  {
    ...
    return { namespace: namespace, ancestorInfo: _ancestorInfo ***REMOVED***
  }
  return namespace;
}
...
function getChildHostContext(parentHostContext, type, rootContainerInstance) {
  {
    ...
    return { namespace: _namespace, ancestorInfo: _ancestorInfo2 ***REMOVED***
  }
...
var warnForMissingKey = function (child) {***REMOVED***

{
  didWarnAboutMaps = false;
  didWarnAboutGenerators = false;
  didWarnAboutStringRefInStrictMode = {***REMOVED***
...
function mountRef(initialValue) {
  var hook = mountWorkInProgressHook();
  var ref = { current: initialValue ***REMOVED***
  {
    Object.seal(ref);
  }
...

{
  ...
  didWarnAboutDefaultPropsOnFunctionComponent = {***REMOVED***
}
...
function createRootErrorUpdate(fiber, errorInfo, expirationTime) {
  ...
  // Caution: React DevTools currently depends on this property
  // being called "element".
  update.payload = { element: null ***REMOVED***
  ...
  if (existingCallbackExpirationTime < expirationTime) {
    ...
    if (expirationTime === Sync) {
      ...
      if (!disableSchedulerTimeoutBasedOnReactExpirationTime && expirationTime !== Never) {
        ...
        options = { timeout: timeout ***REMOVED***
      }
...
var IsThisRendererActing = { current: false ***REMOVED***
...
function scheduleRootUpdate(current$$1, element, expirationTime, suspenseConfig, callback) {
  ...
  // Caution: React DevTools currently depends on this property
  // being called "element".
  update.payload = { element: element ***REMOVED***
