...
class RpcProvider implements RpcProviderInterface {
    ...
    ***REMOVED***
    ...
    private _rpcHandlers: {[id: string]: RpcProviderInterface.RpcHandler<any, any>} = {***REMOVED***
    private _signalHandlers: {[id: string]: Array<RpcProviderInterface.SignalHandler<any>>} = {***REMOVED***
    private _pendingTransactions: {[id: number]: Transaction} = {***REMOVED***
