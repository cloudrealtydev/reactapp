...
class HtmlWebpackPlugin {
  ...
  constructor (options) {
    ...
    const userOptions = options || {***REMOVED***
      ...
      */
      (compilation, callback) => {
        ...
        const injectedHtmlPromise = Promise.all([assetTagGroupsPromise, templateExectutionPromise])
          ...
          .then(([assetTags, html]) => {
            const pluginArgs = {html, headTags: assetTags.headTags, bodyTags: assetTags.bodyTags, plugin: self, outputName: childCompilationOutputName***REMOVED***
        ...
        const emitHtmlPromise = injectedHtmlPromise
          ...
          .then((html) => {
            const pluginArgs = {html, plugin: self, outputName: childCompilationOutputName***REMOVED***
  ...
  htmlWebpackPluginAssets (compilation, childCompilationOutputName, entryNames) {
    ...
    ***REMOVED***
    ...
    const entryPointPublicPathMap = {***REMOVED***
