(function(global, factory) {
  ...
  ***REMOVED***
   ...
   * // object
   * var order = [];
   * var object = { a: 1, b: 3, c: 2 ***REMOVED***
   * var iterator = function(num, done) {
   *   setTimeout(function() {
   *     order.push(num);
   *     done();
   ...
   * // object
   * var order = [];
   * var object = { a: 1, b: 5, c: 3, d: 4, e: 2 ***REMOVED***
   * var iterator = function(num, done) {
   *   setTimeout(function() {
   *     order.push(num);
   *     done(null, num % 2);
   ...
   * // object
   * var order = [];
   * var object = { a: 1, b: 3, c: 2, d: 4 ***REMOVED***
   * var iterator = function(num, done) {
   *   setTimeout(function() {
   *     order.push(num);
   *     done(null, num % 2);
   ...
   * // object
   * var order = [];
   * var object = { a: 4.2, b: 6.4, c: 6.1 ***REMOVED***
   * var iterator = function(num, done) {
   *   setTimeout(function() {
   *     order.push(num);
   *     done(null, Math.floor(num));
  ...
  ***REMOVED***
  ...
  function createTransform(arrayEach, baseEach, symbolEach) {
    return function transform(collection, accumulator, iterator, callback) {
      ...
      if (isArray(collection)) {
        ...
        result = accumulator !== undefined ? accumulator : {***REMOVED***
   ...
   * ***REMOVED***
   * async.transformLimit(object, 2, iterator, function(err, res) {
   *   console.log(res); // { a: 1, b: 5, c: 3, d: 4, e: 2 ***REMOVED***
   *   console.log(order); // [[1, 'a'], [3, 'c'], [5, 'b'], [2, 'e'], [4, 'd']]
   * });
   *
   */
