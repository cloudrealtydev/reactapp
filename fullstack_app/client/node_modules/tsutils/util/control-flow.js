...
const defaultControlFlowEnd = { statements: [], end: false ***REMOVED***
...
function getControlFlowEndWorker(statement) {
    switch (statement.kind) {
        ...
        case ts.SyntaxKind.BreakStatement:
            return { statements: [statement], end: true ***REMOVED***
...
function handleBlock(statement) {
    const result = { statements: [], end: false ***REMOVED***
...
function handleTryStatement(node) {
    ...
    if (node.catchClause === undefined)
        return { statements: finallyResult.statements.concat(tryResult.statements), end: tryResult.end ***REMOVED***
