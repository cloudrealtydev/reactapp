...
```
```javascript
var x={o:0,_:1,l:function(){return this._+this.o}***REMOVED***x.t=2,x.o=3,console.log(x.l());
```
...
```
```javascript
var x={o:0,foo_:1,_:function(){return this.foo_+this.o}***REMOVED***x.bar_=2,x.o=3,console.log(x._());
```
...
```
```javascript
var x={o:0,_:1,calc:function(){return this._+this.o}***REMOVED***x.l=2,x.o=3,console.log(x.calc());
```
...
```
```javascript
var x={o:0,_:1,calc:function(){return this._+this.o}***REMOVED***x.bar_=2,x.o=3,console.log(x.calc());
```
...
var options = { warnings: true ***REMOVED***
var result = UglifyJS.minify(code, options);
...
```javascript
var result = UglifyJS.minify({"file1.js": "var a = function() {***REMOVED***"}, {
    sourceMap: {
        filename: "out.js",
        url: "out.js.map"
    }
