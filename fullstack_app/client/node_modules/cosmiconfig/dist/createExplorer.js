...
class Explorer {
  ...
  getLoaderEntryForFile(filepath        )              {
    if (path.basename(filepath) === 'package.json') {
      ...
      return { sync: loader, async: loader ***REMOVED***
    }

    const loaderKey = path.extname(filepath) || 'noExt';
    return this.config.loaders[loaderKey] || {***REMOVED***
  }
  ...
  loadedContentToCosmiconfigResult(
    ...
    if (loadedContent === undefined) {
      return { filepath, config: undefined, isEmpty: true ***REMOVED***
    }
    return { config: loadedContent, filepath ***REMOVED***
  }
