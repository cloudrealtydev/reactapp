...
var SafeParser = function (_Parser) {
  ...
  ***REMOVED***
  ...
  SafeParser.prototype.comment = function comment(token) {
    ...
    node.source.end = { line: token[4], column: token[5] ***REMOVED***
  ...
  ***REMOVED***
  ...
  SafeParser.prototype.unclosedBracket = function unclosedBracket() {***REMOVED***
  ...
  ***REMOVED***
  ...
  SafeParser.prototype.doubleColon = function doubleColon() {***REMOVED***
  ...
  ***REMOVED***
  ...
  SafeParser.prototype.checkMissedSemicolon = function checkMissedSemicolon() {***REMOVED***
