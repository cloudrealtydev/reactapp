...
function warnNoop(publicInstance, callerName) {
  {
    ...
    warningWithoutStack$1(false, "Can't call %s on a component that is not yet mounted. " + 'This is a no-op, but it might indicate a bug in your application. ' + 'Instead, assign to `this.state` directly or define a `state = {***REMOVED***` ' + 'class property with the desired state in the %s component.', callerName, componentName);
...
var printWarning$1 = function() {***REMOVED***
