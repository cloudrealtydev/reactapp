			...
			(compilation, { normalModuleFactory }) => {
				...
				compilation.hooks.record.tap(
					...
					(compilation, records) => {
						...
						records.moduleHashs = {***REMOVED***
						for (const module of compilation.modules) {
							const identifier = module.identifier();
							records.moduleHashs[identifier] = module.hash;
						}
						records.chunkHashs = {***REMOVED***
						for (const chunk of compilation.chunks) {
							records.chunkHashs[chunk.id] = chunk.hash;
						}
						records.chunkModuleIds = {***REMOVED***
						for (const chunk of compilation.chunks) {
					...
					source => {
						...
						buf.push(
							mainTemplate.requireFn +
								".h = function() { return hotCurrentHash; ***REMOVED***"
						);
							...
							hotInitCode
								...
								.replace(
									...
									needChunkLoadingCode(chunk)
										...
										: `var chunkId = ${JSON.stringify(chunk.id)***REMOVED***`
								)
						]);
					}
				);
