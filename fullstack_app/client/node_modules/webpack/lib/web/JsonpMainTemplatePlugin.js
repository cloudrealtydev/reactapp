		...
		mainTemplate.hooks.jsonpScript.tap(
			...
			(_, chunk, hash) => {
				...
				return Template.asString([
					...
					jsonpScriptType
						? `script.type = ${JSON.stringify(jsonpScriptType)***REMOVED***`
						: "",
					"script.charset = 'utf-8';",
					`script.timeout = ${chunkLoadTimeout / 1000***REMOVED***`,
		...
		mainTemplate.hooks.linkPreload.tap(
			...
			(_, chunk, hash) => {
				...
				return Template.asString([
					...
					jsonpScriptType
						? `link.type = ${JSON.stringify(jsonpScriptType)***REMOVED***`
						: "",
					"link.charset = 'utf-8';",
					`if (${mainTemplate.requireFn}.nc) {`,
					Template.indent(
		...
		mainTemplate.hooks.requireEnsure.tap(
			...
			(source, chunk, hash) => {
				...
				return Template.asString([
					...
					"",
					`var chunkPreloadMap = ${JSON.stringify(chunkMap, null, "\t")***REMOVED***`,
					"",
		...
		mainTemplate.hooks.requireExtensions.tap(
			...
			(source, chunk) => {
				...
				return Template.asString([
					...
					`${mainTemplate.requireFn}.oe = function(err) { console.error(err); throw err; ***REMOVED***`
				]);
			}
		);
