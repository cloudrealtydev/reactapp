...
module.exports = class MainTemplate extends Tapable {
	...
	constructor(outputOptions) {
		super();
		/** @type {TODO?} */
		this.outputOptions = outputOptions || {***REMOVED***
		this.hooks = {
		...
		***REMOVED***
		...
		this.hooks.requireExtensions.tap("MainTemplate", (source, chunk, hash) => {
			...
			buf.push(
				`${this.requireFn}.o = function(object, property) { return Object.prototype.hasOwnProperty.call(object, property); ***REMOVED***`
			);
			...
			buf.push(`${this.requireFn}.p = ${JSON.stringify(publicPath)***REMOVED***`);
			return Template.asString(buf);
		});
	...
	renderAddModule(hash, chunk, varModuleId, varModule) {
		return this.hooks.addModule.call(
			`modules[${varModuleId}] = ${varModule***REMOVED***`,
			chunk,
			hash,
			varModuleId,
			varModule
