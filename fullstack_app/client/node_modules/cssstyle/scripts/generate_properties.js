...
function isRequire(node, filename) {
  if (
    ...
    return { relative: relative, fullPath: fullPath ***REMOVED***
  } else {
    return false;
  }
}
...
parsedFiles.forEach(function(file) {
  var namedExports = {***REMOVED***
  var localVariableMap = {***REMOVED***
