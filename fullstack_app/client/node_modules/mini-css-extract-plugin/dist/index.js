          ...
          const linkHrefPath = mainTemplate.getAssetPath(JSON.stringify(this.options.chunkFilename), {
            ...
            chunk: {
              ...
              contentHashWithLength: {
                [MODULE_TYPE]: length => {
                  const shortContentHashMap = {***REMOVED***
