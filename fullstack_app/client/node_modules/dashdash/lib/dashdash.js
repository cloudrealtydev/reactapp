...
function Parser(config) {
    ...
    this.optionFromName = {***REMOVED***
    this.optionFromEnv = {***REMOVED***
...
Parser.prototype.parse = function parse(inputs) {
    ...
    if (Array.isArray(arguments[0])) {
        inputs = {argv: arguments[0], slice: arguments[1]***REMOVED***
    }
    ...
    function addOpt(option, optstr, key, val, from) {
        ...
        var item = { key: key, value: parsedVal, from: from ***REMOVED***
        _order.push(item);
    }
