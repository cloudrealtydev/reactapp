...
function walk (dir, options, callback) {
  ...
  if (!callback.files) callback.files = {***REMOVED***
...
exports.createMonitor = function (root, options, cb) {
  ...
  var prevFile = {file: null,action: null,stat: null***REMOVED***
  exports.watchTree(root, options, function (f, curr, prev) {
    ...
    if (!prev) {
      if (prevFile.file != f || prevFile.action != "created") {
        prevFile = { file: f, action: "created", stat: curr ***REMOVED***
    ...
    if (curr) {
      if (curr.nlink === 0) {
        if (prevFile.file != f || prevFile.action != "removed") {
          prevFile = { file: f, action: "removed", stat: curr ***REMOVED***
