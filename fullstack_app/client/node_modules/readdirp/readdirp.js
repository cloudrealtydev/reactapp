...
function readdir(opts, callback1, callback2) {
  ...
  if (isUndefined(callback1)) {
    ...
    handleError      =  function (err) { errors.push(err); ***REMOVED***
  ...
  opts.root            =  opts.root            || '.';
  opts.fileFilter      =  opts.fileFilter      || function() { return true; ***REMOVED***
  opts.directoryFilter =  opts.directoryFilter || function() { return true; ***REMOVED***
