    ...
    switch (node.type) {
          ...
          if (isScoped) {
            ...
            ***REMOVED***
            ...
            if (newNodes.length) {
              ...
              first.spaces = { before, after: first.spaces.after ***REMOVED***
              last.spaces = { before: last.spaces.before, after ***REMOVED***
            }
      ...
      case 'class': {
        if (!context.global) {
          ...
          innerNode.spaces = { before: '', after: '' ***REMOVED***
...
module.exports = postcss.plugin('postcss-modules-local-by-default', function(
  ...
  if (typeof options !== 'object') {
    options = {***REMOVED*** // If options is undefined or not an object the plugin fails
  }
