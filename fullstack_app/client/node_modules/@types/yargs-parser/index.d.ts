...
declare namespace yargsParser {
    ...
    interface Options {
        ...
        alias?: { [key: string]: string | string[] ***REMOVED***
        /**
        ...
        config?: string | string[] | { [key: string]: boolean ***REMOVED***
         ...
         */
        coerce?: { [key: string]: (arg: any) => any ***REMOVED***
        /** Indicate a key that should be used as a counter, e.g., `-vvv = {v: 3}`. */
        count?: string[];
        /** Provide default values for keys: `{ default: { x: 33, y: 'hello world!' } }`. */
        default?: { [key: string]: any ***REMOVED***
        /** Environment variables (`process.env`) with the prefix provided should be parsed. */
        envPrefix?: string;
        /** Specify that a key requires n arguments: `{ narg: {x: 2} }`. */
        narg?: { [key: string]: number ***REMOVED***
