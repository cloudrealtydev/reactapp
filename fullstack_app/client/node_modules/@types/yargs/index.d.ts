...
declare namespace yargs {
    ...
    interface Argv<T = {}> {
        ...
        parse(arg: string | ReadonlyArray<string>, context?: object, parseCallback?: ParseCallback<T>): { [key in keyof Arguments<T>]: Arguments<T>[key] ***REMOVED***
    ...
    ***REMOVED***
    ...
    interface Options {
        ...
        conflicts?: string | ReadonlyArray<string> | { [key: string]: string | ReadonlyArray<string> ***REMOVED***
        ...
        implies?: string | ReadonlyArray<string> | { [key: string]: string | ReadonlyArray<string> ***REMOVED***
    ...
    type InferredOptionTypes<O extends { [key: string]: Options }> = { [key in keyof O]: InferredOptionType<O[key]> ***REMOVED***
