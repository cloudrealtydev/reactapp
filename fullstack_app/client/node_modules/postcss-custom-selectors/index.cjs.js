...
var getCustomSelectors = ((root, opts) => {
  ...
  const customSelectors = {***REMOVED*** // for each custom selector atrule that is a child of the css root
...
function importCustomSelectorsFromSources(sources) {
  return sources.map(source => {
    ...
    const opts = source === Object(source) ? source : {
      from: String(source)
    ***REMOVED*** // skip objects with custom selectors
  ...
  function () {
    var _ref = _asyncToGenerator(function* (destination) {
      if (destination instanceof Function) {
        ...
        ***REMOVED*** // transformer for custom selectors into a JSON-compatible object
