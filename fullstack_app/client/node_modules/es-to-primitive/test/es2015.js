...
var coercibleObject = { valueOf: function () { return 3; }, toString: function () { return 42; } ***REMOVED***
var valueOfOnlyObject = { valueOf: function () { return 4; }, toString: function () { return {***REMOVED*** } ***REMOVED***
var toStringOnlyObject = { valueOf: function () { return {***REMOVED*** }, toString: function () { return 7; } ***REMOVED***
var coercibleFnObject = {
	valueOf: function () { return function valueOfFn() {***REMOVED*** },
	toString: function () { return 42; }
***REMOVED***
var uncoercibleObject = { valueOf: function () { return {***REMOVED*** }, toString: function () { return {***REMOVED*** } ***REMOVED***
var uncoercibleFnObject = {
	valueOf: function () { return function valueOfFn() {***REMOVED*** },
	toString: function () { return function toStrFn() {***REMOVED*** }
***REMOVED***
...
test('Objects', function (t) {
	...
	t.test('Symbol.toPrimitive', { skip: !hasSymbolToPrimitive }, function (st) {
		...
		overriddenObject[Symbol.toPrimitive] = function (hint) { return String(hint); ***REMOVED***
		...
		var nullToPrimitive = { toString: coercibleObject.toString, valueOf: coercibleObject.valueOf ***REMOVED***
		...
		st.test('exceptions', function (sst) {
			...
			uncoercibleToPrimitive[Symbol.toPrimitive] = function (hint) {
				return { toString: function () { return hint; } ***REMOVED***
			***REMOVED***
			...
			throwingToPrimitive[Symbol.toPrimitive] = function (hint) { throw new RangeError(hint); ***REMOVED***
