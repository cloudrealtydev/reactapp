...
var Tracer = /** @class */ (function (_super) {
    ...
    function Tracer(opts) {
        ...
        if (_this.parent) {
            ...
            var streamOpts = { objectMode: _this._objectMode ***REMOVED***
    ...
    ***REMOVED***
    Tracer.prototype._read = function (_) { ***REMOVED***
