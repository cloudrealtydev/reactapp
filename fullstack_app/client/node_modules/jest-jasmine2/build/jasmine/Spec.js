...
class Spec {
  ...
  constructor(attrs) {
    ...
    this.resultCallback = attrs.resultCallback || function() {***REMOVED***
    ...
    this.onStart = attrs.onStart || function() {***REMOVED***
    ...
    this.queueRunnerFactory = attrs.queueRunnerFactory || function() {***REMOVED***
