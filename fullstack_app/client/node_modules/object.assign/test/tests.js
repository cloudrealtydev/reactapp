...
module.exports = function (assign, t) {
	...
	t.test('merge N objects', function (st) {
		var target = { a: 1 ***REMOVED***
		var source1 = { b: 2 ***REMOVED***
		var source2 = { c: 3 ***REMOVED***
	...
	t.test('checks enumerability and existence, in case of modification during [[Get]]', { skip: !Object.defineProperty }, function (st) {
		var targetBvalue = {***REMOVED***
		var targetCvalue = {***REMOVED***
		var target = { b: targetBvalue, c: targetCvalue ***REMOVED***
		var source = {***REMOVED***
		...
		var sourceBvalue = {***REMOVED***
		var sourceCvalue = {***REMOVED***
