...
***REMOVED*** // We allow `jest`, `expect`, `require`, all default Node.js globals and all
...
const JEST_GLOBAL = {
  name: 'jest'
***REMOVED*** // TODO: Should be Visitor<{ids: Set<NodePath<Identifier>>}>, but `ReferencedIdentifier` doesn't exist
