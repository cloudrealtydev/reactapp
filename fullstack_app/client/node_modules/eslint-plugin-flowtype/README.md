...
a(foo => { if (true) {***REMOVED*** });
// Message: undefined

a(async foo => { if (true) {***REMOVED*** });
// Message: undefined
...
a.then((foo) => { if (true) {***REMOVED*** });

a.then(async (foo) => { if (true) {***REMOVED*** });
...
var d = {***REMOVED*** type f = { get(key: d): string, get(key: d): string }
// Message: Duplicate property.
...
function fn() {***REMOVED*** type f = { get(key: fn): string, get(key: fn): string }
// Message: Duplicate property.
```
...
var a = {***REMOVED*** var b = {***REMOVED*** type f = { get(key: a): string, get(key: b): string }
...
const foo: { n: number } & { s: string } = { n: 0, s: "" ***REMOVED***
// Message: All intersection types must be declared with named type alias.

type Foo = { bar: { n: number } & { s: string } ***REMOVED***
// Message: All intersection types must be declared with named type alias.
...
type Foo = { disjoint: "A", n: number } | { disjoint: "B", s: string ***REMOVED***

type Foo = { n: number } & { s: string ***REMOVED***

type Bar = { n: number } & { s: string ***REMOVED*** function foo(bar: Bar) {}
...
```js
type Props = { ***REMOVED*** class Foo extends React.Component<Props> { }
// Message: Props must be $ReadOnly

type OtherProps = { foo: string ***REMOVED*** class Foo extends React.Component<OtherProps> { }
// Message: OtherProps must be $ReadOnly

class Foo extends React.Component<{}> { }
// Message: Foo class props must be $ReadOnly

type Props = { bar: {} ***REMOVED*** class Foo extends React.Component<Props, State> { }
// Message: Props must be $ReadOnly

type Props = { ***REMOVED*** class Foo extends Component<Props> { }
// Message: Props must be $ReadOnly

type Props = { ***REMOVED*** class Foo extends PureComponent<Props> { }
// Message: Props must be $ReadOnly

export type Props = {***REMOVED*** class Foo extends Component<Props> { }
// Message: Props must be $ReadOnly

type Props = {| foo: string |***REMOVED*** class Foo extends Component<Props> { }
// Message: Props must be $ReadOnly

type Props = {| +foo: string, ...bar |***REMOVED*** class Foo extends Component<Props> { }
// Message: Props must be $ReadOnly

type Props = {| +foo: string, -bar: number |***REMOVED*** class Foo extends Component<Props> { }
// Message: Props must be $ReadOnly

type Props = { ***REMOVED*** function Foo(props: Props) { return <p /> }
// Message: Props must be $ReadOnly

type Props = { ***REMOVED*** function Foo(props: Props) { return foo ? <p /> : <span /> }
// Message: Props must be $ReadOnly

function Foo(props: {}) { return <p /> }
// Message: Foo component props must be $ReadOnly

export type Props = {***REMOVED*** function Foo(props: Props) { return <p /> }
// Message: Props must be $ReadOnly
```
...
type FooType = {***REMOVED*** class Foo extends Bar<FooType> { }
...
type Props = {***REMOVED*** function Foo() { }

type Props = $ReadOnly<{}>; function Foo(props: Props) { }

type Props = {***REMOVED*** function Foo(props: OtherProps) { }
...
type foo = {test: number***REMOVED*** type bar = {...foo}
// Message: Use $Exact to make type spreading safe.
```
...
type foo = {test: number***REMOVED*** type bar = {...$Exact<foo>}
```
...
type X = {x: string}|{y: number***REMOVED***
// Message: There must be a space before union type annotation separator
// Message: There must be a space after union type annotation separator
...
import type A from "a"; type X<B = ComponentType<A>> = { b: B ***REMOVED*** let x: X; console.log(x);
// Additional rules: {"no-unused-vars":1}

import type A from "a"; type X<B = A<string>> = { b: B ***REMOVED*** let x: X; console.log(x);
// Additional rules: {"no-unused-vars":1}
```
