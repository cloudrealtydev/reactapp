...
try {
	...
	asyncFn = Function('return async function foo() {***REMOVED***')();
	asyncArrowFn = Function('return async () => {***REMOVED***')();
} catch (e) { /**/ }
var forEach = require('foreach');

var noop = function () {***REMOVED***
var classFake = function classFake() { ***REMOVED*** // eslint-disable-line func-name-matching
var returnClass = function () { return ' class '; ***REMOVED***
var return3 = function () { return 3; ***REMOVED***
/* for coverage */
noop();
classFake();
returnClass();
