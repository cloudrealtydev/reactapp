...
sorted(Object.keys(packages)).forEach(function(pkgname) {
    var pkgopts = packages[pkgname] || {***REMOVED***
    var script = [];
    var emit = function(l) { script.push(l); ***REMOVED***
    var m;
    if (pkgname==='process') {
        m = process;
    } else if (pkgopts.optional) {
        // Package is not present in older versions of node.
        emit('var '+pkgname+' = {***REMOVED***');
