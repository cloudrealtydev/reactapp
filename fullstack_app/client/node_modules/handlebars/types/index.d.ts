...
declare namespace Handlebars {
  ...
  export interface RuntimeOptions {
      partial?: boolean;
      depths?: any[];
      helpers?: { [name: string]: Function ***REMOVED***
      partials?: { [name: string]: HandlebarsTemplateDelegate ***REMOVED***
      decorators?: { [name: string]: Function ***REMOVED***
      data?: any;
      blockParams?: any[];
  ...
  export const helpers: { [name: string]: HelperDelegate ***REMOVED***
  export const partials: { [name: string]: any ***REMOVED***
  // TODO: replace Function with actual signature
  export const decorators: { [name: string]: Function ***REMOVED***
...
interface Logger {
  ...
  methodMap: { [level: number]: string ***REMOVED***
