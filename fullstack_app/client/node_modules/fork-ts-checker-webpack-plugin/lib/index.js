...
class ForkTsCheckerWebpackPlugin {
    ...
    validateTslint(options) {
        ...
        return { tslint, tslintAutoFix, tslintVersion ***REMOVED***
    }
    validateEslint(options) {
        let eslintVersion;
        const eslintOptions = typeof options.eslintOptions === 'object' ? options.eslintOptions : {***REMOVED***
        try {
        ...
        return { eslintVersion, eslintOptions ***REMOVED***
    }
    ...
    createNoopEmitCallback() {
        ...
        return function noopEmitCallback() { ***REMOVED***
    }
