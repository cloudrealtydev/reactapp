...
UChar.fromCharCode = strategies.reduceRight(function (next, strategy) {
	return function (cp, needFeature) { return strategy(next, cp, needFeature); ***REMOVED***
}, null);

UChar.isHighSurrogate = function (cp) { return cp >= 0xd800 && cp <= 0xdbff; ***REMOVED***
UChar.isLowSurrogate = function (cp) { return cp >= 0xdc00 && cp <= 0xdfff; ***REMOVED***
