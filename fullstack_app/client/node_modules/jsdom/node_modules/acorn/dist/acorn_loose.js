...
var LooseParser = function LooseParser(input, options) {
  ...
  this.tok = this.last = {type: __acorn.tokTypes.eof, start: 0, end: 0***REMOVED***
...
LooseParser.prototype.dummyNode = function dummyNode (type) {
  ...
  this.last = {type: __acorn.tokTypes.name, start: dummy.start, end: dummy.start, loc: dummy.loc***REMOVED***
  return dummy
***REMOVED***
  ...
  for (;;) {
    try {
      ...
      if (/unterminated/i.test(msg)) {
        ...
        if (/string/.test(msg)) {
          replace = {start: e.pos, end: pos, type: __acorn.tokTypes.string, value: this$1.input.slice(e.pos + 1, pos)***REMOVED***
        } else if (/regular expr/i.test(msg)) {
          var re = this$1.input.slice(e.pos, pos);
          try { re = new RegExp(re); } catch (e) { /* ignore compilation error due to new syntax */ }
          replace = {start: e.pos, end: pos, type: __acorn.tokTypes.regexp, value: re***REMOVED***
      ...
      this$1.resetTo(pos);
      if (replace === true) { replace = {start: pos, end: pos, type: __acorn.tokTypes.name, value: "✖"***REMOVED*** }
      if (replace) {
