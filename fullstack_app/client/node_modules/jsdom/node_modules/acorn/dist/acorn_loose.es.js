...
var LooseParser = function LooseParser(input, options) {
  ...
  this.tok = this.last = {type: tokTypes.eof, start: 0, end: 0***REMOVED***
  ...
  // Load plugins
  this.options.pluginsLoose = options.pluginsLoose || {***REMOVED***
...
LooseParser.prototype.dummyNode = function dummyNode (type) {
  ...
  this.last = {type: tokTypes.name, start: dummy.start, end: dummy.start, loc: dummy.loc***REMOVED***
  return dummy
***REMOVED***
  ...
  for (;;) {
    try {
      ...
      if (/unterminated/i.test(msg)) {
        ...
        if (/string/.test(msg)) {
          replace = {start: e.pos, end: pos, type: tokTypes.string, value: this$1.input.slice(e.pos + 1, pos)***REMOVED***
        } else if (/regular expr/i.test(msg)) {
          var re = this$1.input.slice(e.pos, pos);
          try { re = new RegExp(re); } catch (e) { /* ignore compilation error due to new syntax */ }
          replace = {start: e.pos, end: pos, type: tokTypes.regexp, value: re***REMOVED***
      ...
      this$1.resetTo(pos);
      if (replace === true) { replace = {start: pos, end: pos, type: tokTypes.name, value: "✖"***REMOVED*** }
      if (replace) {
...
lp$2.parseExprAtom = function() {
  ...
  case tokTypes.regexp:
    ...
    node.regex = {pattern: val.pattern, flags: val.flags***REMOVED***
...
lp$2.parseTemplate = function() {
  ...
  while (!curElt.tail) {
    ...
    if (this$1.expect(tokTypes.braceR)) {
      ...
      curElt.value = {cooked: "", raw: ""***REMOVED***
      curElt.tail = true;
...
export { parse_dammit, LooseParser, pluginsLoose ***REMOVED***
