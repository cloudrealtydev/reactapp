...
internals.Alternatives = class extends Any {
    ...
    _base(value, state, options) {
        ...
        if (errors.length) {
            return { errors: this.createError('alternatives.child', { reason: errors }, state, options) ***REMOVED***
        }

        return { errors: this.createError('alternatives.base', null, state, options) ***REMOVED***
    }
    ...
    label(name) {
        ...
        obj._inner.matches = obj._inner.matches.map((match) => {
            ...
            if (match.schema) {
                return { schema: match.schema.label(name) ***REMOVED***
            }
