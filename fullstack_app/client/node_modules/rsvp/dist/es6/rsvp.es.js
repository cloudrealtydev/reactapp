...
function callbacksFor(object) {
  ...
  if (!callbacks) {
    callbacks = object._promiseCallbacks = {***REMOVED***
  }
...
var EventTarget = {
  ...
  */
  ...
  /**
    ...
    ```javascript
    let callback1 = function(){***REMOVED***
    let callback2 = function(){***REMOVED***
...
const TRY_CATCH_ERROR = { error: null ***REMOVED***
...
function defer(label) {
  let deferred = { resolve: undefined, reject: undefined ***REMOVED***
...
/**
  ...
  ***REMOVED***
  ...
  let alice = { name: 'alice' ***REMOVED***
  let bob   = { name: 'bob' ***REMOVED***
  let users = [ alice, bob ];
...
const browserGlobal = browserWindow || {***REMOVED***
...
export default rsvp;
export { asap, cast, Promise, EventTarget, all$1 as all, allSettled, race$1 as race, hash, hashSettled, rethrow, defer, denodeify, configure, on, off, resolve$2 as resolve, reject$2 as reject, map, async, filter ***REMOVED***
