...
class ExportMap {
   ...
   */
  hasDeep(name) {
    if (this.namespace.has(name)) return { found: true, path: [this] ***REMOVED***
    ...
    if (this.reexports.has(name)) {
      ...
      ***REMOVED***if (imported.path === this.path && reexports.local === name) {
...
const availableDocStyleParsers = {
   ...
   * @return {{doc: object}}
   */
***REMOVED***function captureJsDoc(comments) {
  let doc;
