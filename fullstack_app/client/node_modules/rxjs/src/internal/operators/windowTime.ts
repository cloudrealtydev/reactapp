...
class WindowTimeSubscriber<T> extends Subscriber<T> {
  ...
  constructor(protected destination: Subscriber<Observable<T>>,
    ...
    if (windowCreationInterval !== null && windowCreationInterval >= 0) {
      const closeState: CloseState<T> = { subscriber: this, window, context: <any>null ***REMOVED***
      const creationState: CreationState<T> = { windowTimeSpan, windowCreationInterval, subscriber: this, scheduler ***REMOVED***
      ...
      const timeSpanOnlyState: TimeSpanOnlyState<T> = { subscriber: this, window, windowTimeSpan ***REMOVED***
...
function dispatchWindowCreation<T>(this: SchedulerAction<CreationState<T>>, state: CreationState<T>): void {
  ...
  const action = this;
  let context: CloseWindowContext<T> = { action, subscription: <any>null ***REMOVED***
  const timeSpanState: CloseState<T> = { subscriber, window, context ***REMOVED***
