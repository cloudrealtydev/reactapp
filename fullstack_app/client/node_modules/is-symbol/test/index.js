...
var debug = function (v, m) { return inspect(v) + ' ' + m; ***REMOVED***
...
test('faked symbol values', function (t) {
	t.test('real symbol valueOf', { skip: !hasSymbols }, function (st) {
		var fakeSymbol = { valueOf: function () { return Symbol('foo'); } ***REMOVED***
	...
	t.test('faked @@toStringTag', { skip: !hasSymbols || !Symbol.toStringTag }, function (st) {
		...
		var notSoFakeSymbol = { valueOf: function () { return 42; } ***REMOVED***
	...
	var fakeSymbolString = { toString: function () { return 'Symbol(foo)'; } ***REMOVED***
