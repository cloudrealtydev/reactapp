...
class Topology extends EventEmitter {
  ...
  constructor(seedlist, options) {
    ...
    ***REMOVED***
    ...
    this.s.options.compression = { compressors: createCompressionInfo(options) ***REMOVED***
  ...
  lastIsMaster() {
    ...
    if (serverDescriptions.length === 0) return {***REMOVED***

    const sd = serverDescriptions.filter(sd => sd.type !== ServerType.Unknown)[0];
    const result = sd || { maxWireVersion: this.description.commonWireVersion ***REMOVED***
    return result;
  }
