...
Collection.prototype.insertMany = function(docs, options, callback) {
  if (typeof options === 'function') (callback = options), (options = {});
  options = options ? Object.assign({}, options) : { ordered: true ***REMOVED***
...
Collection.prototype.createIndexes = function(indexSpecs, options, callback) {
  ...
  options = options ? Object.assign({}, options) : {***REMOVED***
...
Collection.prototype.distinct = function(key, query, options, callback) {
  const args = Array.prototype.slice.call(arguments, 1);
  callback = typeof args[args.length - 1] === 'function' ? args.pop() : undefined;
  const queryOption = args.length ? args.shift() || {} : {***REMOVED***
  const optionsOption = args.length ? args.shift() || {} : {***REMOVED***
