...
Query.prototype.projection = function(arg) {
  ...
  this._fields = {***REMOVED***
  this._userProvidedFields = {***REMOVED***
  this.select(arg);
  return this._fields;
***REMOVED***
...
Query.prototype.setOptions = function(options, overwrite) {
  ...
  if (overwrite) {
    ...
    this._mongooseOptions = (options && utils.clone(options)) || {***REMOVED***
...
Query.prototype.set = function(path, val) {
  ...
  this._update.$set = this._update.$set || {***REMOVED***
...
Query.prototype._find = wrapThunk(function(callback) {
  ...
  const _this = this;
  const userProvidedFields = _this._userProvidedFields || {***REMOVED***
...
Query.prototype.merge = function(source) {
  ...
  const opts = { overwrite: true ***REMOVED***
...
Query.prototype._completeOne = function(doc, res, callback) {
  ...
  const userProvidedFields = this._userProvidedFields || {***REMOVED***
  // `populate`, `lean`
  const mongooseOptions = this._mongooseOptions;
  // `rawResult`
  ...
  if (this.options != null) {
    ...
    for (let i = 0; i < res.length; ++i) {
      if (readConcern != null && get(res[i], 'options.readConcern') == null) {
        res[i].options = res[i].options || {***REMOVED***
...
Query.prototype.getPopulatedPaths = function getPopulatedPaths() {
  const obj = this._mongooseOptions.populate || {***REMOVED***
...
if (Symbol.asyncIterator != null) {
  Query.prototype[Symbol.asyncIterator] = function() {
    return this.cursor().transformNull().map(doc => {
      return doc == null ? { done: true } : { value: doc, done: false ***REMOVED***
    });
  ***REMOVED***
}
